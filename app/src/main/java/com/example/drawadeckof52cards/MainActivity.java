...
//        labai1.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                clickEachCardHandle(labai1);
//            }
//        });
//        labai2.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                clickEachCardHandle(labai2);
//            }
//        });
//        labai3.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                clickEachCardHandle(labai3);
//            }
//        });
    }
    ...
    void clickHandle( ){
        ...
        while(true)
        {
            ...
            if(!cacladarut.contains(mangtenbai[x][y]))
            {
...
//                    rutbai.setEnabled(false);
        ...
        thongbao.setText("Các lá đã rút là "+cacladarut.toString()
                +chuoithongbao +" ba tây "+batay);
    }
//    void clickEachCardHandle(ImageView card){
//        if(darut==0)//lan dau hoac rut lai
//        {
//            darut=0;
//            sonut=0;
...
//        {
//            sonut+=(y<10)?y:0;
//            card.setImageResource(manghinhbai[x][y]);
//        }
//        else if(darut==2)
//        {
//            sonut+=(y<10)?y:0;
